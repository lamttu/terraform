...
module "elb_http" {
  ...
  # We can use * here to specify all
...
resource "aws_instance" "app" {
  ...
  # Each instance will have a different incrementing value for count.index 
  # We are using modulo here because the result of the modulo operation will range from 0 to the largest index possible
  # That will keep looping until the end of the count
